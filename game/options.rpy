...
define config.version = "market"


## Text that is placed on the game's about screen. Place the text between the
## triple-quotes, and leave a blank line between paragraphs.

define gui.about = _p("""This is the Early Access Version for Lighter. All the Copy right belongs to the Yuki AVG Production Team.
""")
...
define config.save_directory = "Lighter-SAVE"
